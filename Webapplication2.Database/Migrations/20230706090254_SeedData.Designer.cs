...
namespace Webapplication2.Database.Migrations
{
    ...
    [Migration("20230706090254_SeedData")]
            ...
            modelBuilder.Entity("WebApplication2.Models.Todoo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Animal = 2,
                            Created = new DateTime(2023, 7, 6, 14, 32, 53, 809, DateTimeKind.Local).AddTicks(5847),
                            Description = "ME kathawen kiyawenne siriyawathi gana",
                            Due = new DateTime(2023, 7, 13, 14, 32, 53, 809, DateTimeKind.Local).AddTicks(5858),
                            Status = 2,
